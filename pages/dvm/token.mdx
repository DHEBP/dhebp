...
This function is used to initialize parameters during install time. It initializes a private SC.
...
This function is used to change the owner. The owner is a string form of an address.
...
If signer is the owner, provide him rights to update code anytime.
